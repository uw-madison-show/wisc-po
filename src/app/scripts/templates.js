...
this["App"]["templates"]["chart_data"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<div class=\"content-container\">\r\n\r\n";
  stack1 = this.invokePartial(partials.header, '  ', 'header', depth0, {
    'active_charts': (true)
  }, helpers, partials, data);
  if (stack1 != null) { buffer += stack1; }
